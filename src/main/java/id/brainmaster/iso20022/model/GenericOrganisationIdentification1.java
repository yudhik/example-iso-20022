 ...
 *         &lt;element name="SchmeNm" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.07}OrganisationIdentificationSchemeName1Choice" minOccurs="0"/>
...
@XmlType(name = "GenericOrganisationIdentification1", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.07", propOrder = {
    "id",
    "schmeNm",
    "issr"
})
